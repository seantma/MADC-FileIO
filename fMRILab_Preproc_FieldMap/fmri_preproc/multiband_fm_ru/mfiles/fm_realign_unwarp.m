...
% Delete the .nii with the extra ref frame at beginning
delete(strFileTmp)
...
% Strip off first vol of motion parameter file
!tail -n +2 rp_*.txt > realign.txt
strFileParams = fullfile(strNiiPath,['rp_' strNiiName '.txt']);
movefile('realign.txt',strFileParams);