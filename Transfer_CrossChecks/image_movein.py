# MADC fMRI data move in script
# Functions:
#     1. `rsync` from fmri-Lab
#     2. pull in GoogleSheet for T1/T2
#     3. `lftp` pulled result to MBox
#
# #
#
# Sean Ma, June 2, 2017
...
# open the fmri tracker file and open first sheet
sheet = client.open("fMRI_Tracker").sheet1

# extract sheet data and print all values
list_of_hashes = sheet.get_all_records()
print(list_of_hashes)

# try using pandas to read in dataframe
